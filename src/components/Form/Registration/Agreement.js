  ...
  render() {
    return (
      <section className="Agreement">
        ...
        <header className="h5">SANITATION</header>
        ...
        <header className="h5">SCHEDULING</header>
        ...
        <header className="h5">PAYMENT AND CANCELLATIONS</header>
        ...
        <header className="h5">LATE PICK-UP POLICY</header>
        ...
        <header className="h5">PHOTO, VIDEO OR OTHER RECORDING CONSENT</header>
        ...
        <header className="h5">MEDICAL CONSENT</header>
